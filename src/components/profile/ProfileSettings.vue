	...
	<n-card class="settings">
		<n-form ref="refForm" :label-width="80" :model="formValue" :rules="formRules">
			...
			<div class="flex justify-between flex-col md:flex-row md:gap-4">
				...
				<n-form-item label="Phone Number" path="website" class="basis-1/2">
					<n-input v-model:value="formValue.phone" placeholder="Type phone Number" />
				</n-form-item>
			</div>
			<div class="title">Social</div>
			<div class="flex justify-start flex-col md:flex-row md:gap-4">
